...
export default function Home() {
  ...
  return (
    <main className="bg-black text-white">
      ...
      <header className="fixed top-0 w-full z-50 bg-black/70 backdrop-blur-md">
        <div className="flex justify-between items-center px-6 py-4 max-w-6xl mx-auto">
          ...
          <nav className="hidden md:flex gap-6 text-sm">
            ...
            <button onClick={() => scrollToSection("horarios")}>
              Horários
            </button>
      ...
      <section
        id="coaches"
        className="min-h-[calc(100vh-80px)] flex items-center justify-center bg-zinc-950"
      >
        <div className="text-center max-w-2xl px-6">
          ...
          <p className="text-gray-400 mb-8">
            Adaptamos cada treino ao seu nível para você evoluir no seu ritmo, com foco em técnica, segurança e evolução contínua.
          </p>
